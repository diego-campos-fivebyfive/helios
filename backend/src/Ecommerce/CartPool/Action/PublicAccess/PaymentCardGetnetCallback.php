...
class PaymentCardGetnetCallback extends AbstractController
{
    /**
     * @Route("/payment/card", name="payment_callback_card")
     * @Method("get")
     *
    ...
    public function __invoke(Request $request)
    {
        ...
        $status = $getnetService->processPaymentCard($cartPoolId, $queryParams);
