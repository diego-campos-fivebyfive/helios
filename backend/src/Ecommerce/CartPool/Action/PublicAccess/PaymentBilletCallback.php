...
class PaymentBilletCallback extends AbstractController
{
    /**
     * @Route("/payment/billet", name="payment_callback_billet")
     * @Method("get")
     *
    ...
    public function __invoke(Request $request)
    {
        ...
        $status = $getnetService->processPaymentBillet($billetId, $queryParams);
